...
var items = [
    ...
    ["stop", "MQuestion", {html: inst + "<p>Katherine says, " +  notNegItems[5] +"</p>", q: "Given what " +
              "your friend told you, do you think it's possible people were smirking before the slide?"},
              "MQuestion", questionGen(inst + "<p>Katherine says, " + notNegItems[5] +"</p>", 0),
              "MQuestion", questionGen(inst + "<p>Katherine says, " + notNegItems[5] +"</p>", 1),
              "MQuestion", questionGen(inst + "<p>Katherine says, " + notNegItems[5] +"</p>", 2),
              "MQuestion", questionGen(inst + "<p>Katherine says, " + notNegItems[5] +"</p>", 3),
              "MQuestion", questionGen(inst + "<p>Katherine says, " + notNegItems[5] +"</p>", 4),
              "MQuestion", questionGen(inst + "<p>Katherine says, " + notNegItems[5] +"</p>", 5)],
    ...
    ["filler", "MQuestion", {html: inst + "<p>Emily says, " +  fillerItems[10] +"</p>", q: "Given what " +
              ...
              "MQuestion", questionGen(inst + "<p>Emily says, " + fillerItems[10] +"</p>", 3),
    ...
    ["filler", "MQuestion", {html: inst + "<p>Chelsea says, " +  fillerItems[11] +"</p>", q: "Given what " + 
              ...
              "MQuestion", questionGen(inst + "<p>Chelsea says, " + fillerItems[11] +"</p>", 3),
    ...
    ["filler", "MQuestion", {html: inst + "<p>Allison says, "+ notNegItems[12] +"</p>", q: "Given what " +
              ...
              "MQuestion", questionGen(inst + "<p>Allison says, " + notNegItems[12] +"</p>", 3),
    ...
    ["filler", "MQuestion", {html: inst + "<p>Zack says, " +  notNegItems[13] +"</p>", q: "Given what " +
              ...
              "MQuestion", questionGen(inst + "<p>Zack says, " + fillerItems[13] +"</p>", 3),
    ...
    ["filler", "MQuestion", {html: inst + "<p>Elle says, " +  fillerItems[14] +"</p>", q: "Given what " +
              ...
              "MQuestion", questionGen(inst + "<p>Elle says, " + fillerItems[14] +"</p>", 3),
    ...
    ["filler", "MQuestion", {html: inst + "<p>Katherine says, " +  fillerItems[15] +"</p>", q: "Given what " +
              ...
              "MQuestion", questionGen(inst + "<p>Katherine says, " + fillerItems[15] +"</p>", 3),
    ...
    ["filler", "MQuestion", {html: inst + "<p>John says, " +  fillerItems[16] +"</p>", q: "Given what " +
              ...
              "MQuestion", questionGen(inst + "<p>John says, " + fillerItems[16] +"</p>", 3),
    ...
    ["filler", "MQuestion", {html: inst + "<p>Cathy says, " +  fillerItems[17] +"</p>", q: "Given what " +
              ...
              "MQuestion", questionGen(inst + "<p>Cathy says, " + fillerItems[17] +"</p>", 3),
    ...
    ["filler", "MQuestion", {html: inst + "<p>Jacob says, " +  fillerItems[18] +"</p>", q: "Given what " +
              ...
              "MQuestion", questionGen(inst + "<p>Jacob says, " + fillerItems[18] +"</p>", 3),
    ...
    ["filler", "MQuestion", {html: inst + "<p>Robert says, " +  fillerItems[19] +"</p>", q: "Given what " +
              ...
              "MQuestion", questionGen(inst + "<p>Robert says, " + fillerItems[19] +"</p>", 3),
              "MQuestion", questionGen(inst + "<p>Robert says, " + fillerItems[19] +"</p>", 4),
              "MQuestion", questionGen(inst + "<p>Robert says, " + fillerItems[19] +"</p>", 5)],
];
